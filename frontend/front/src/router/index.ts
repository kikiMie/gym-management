...
const routes = [
  ...
  {
    path: "/member/selMember",
    component: MemberSelMember,
    meta: { requiresAuth: true, role: "admin" },
  },
  {
    path: "/member/toAddMember",
    component: MemberToAddMember,
    meta: { requiresAuth: true, role: "admin" },
  },
  {
    path: "/member/toUpdateMember",
    component: MemberToUpdateMember,
    meta: { requiresAuth: true, role: "admin" },
  },
  {
    path: "/member/toSelByCard",
    component: MemberToSelByCard,
    meta: { requiresAuth: true, role: "admin" },
  },

  {
    path: "/employee/selEmployee",
    component: EmployeeSelEmployee,
    meta: { requiresAuth: true, role: "admin" },
  },
  {
    path: "/employee/toAddEmployee",
    component: EmployeeToAddEmployee,
    meta: { requiresAuth: true, role: "admin" },
  },
  {
    path: "/employee/toUpdateEmployee",
    component: EmployeeToUpdateEmployee,
    meta: { requiresAuth: true, role: "admin" },
  },

  {
    path: "/equipment/selEquipment",
    component: EquipmentSelEquipment,
    meta: { requiresAuth: true, role: "admin" },
  },
  {
    path: "/equipment/toAddEquipment",
    component: EquipmentToAddEquipment,
    meta: { requiresAuth: true, role: "admin" },
  },
  {
    path: "/equipment/toUpdateEquipment",
    component: EquipmentToUpdateEquipment,
    meta: { requiresAuth: true, role: "admin" },
  },

  {
    path: "/class/selClass",
    component: ClassSelClass,
    meta: { requiresAuth: true, role: "admin" },
  },
  {
    path: "/class/toAddClass",
    component: ClassToAddClass,
    meta: { requiresAuth: true, role: "admin" },
  },
  {
    path: "/class/selClassOrder",
    component: ClassSelClassOrder,
    meta: { requiresAuth: true, role: "admin" },
  },

  // 用户端
  {
    path: "/user/toUserInfo",
    component: UserToUserInfo,
    meta: { requiresAuth: true, role: "user" },
  },
  {
    path: "/user/toUpdateInfo",
    component: UserToUpdateInfo,
    meta: { requiresAuth: true, role: "user" },
  },
  {
    path: "/user/toUserClass",
    component: UserToUserClass,
    meta: { requiresAuth: true, role: "user" },
  },
  {
    path: "/user/toApplyClass",
    component: UserToApplyClass,
    meta: { requiresAuth: true, role: "user" },
  },
  {
    path: "/user/toChat",
...
router.beforeEach(async (to) => {
  ...
  try {
    if (role === "user") {
      await api.get("/api/userMain");
    } else {
      await api.get("/api/adminMain");
    }
    return true;
  } catch (e) {
    // 未登录/会话失效：按角色回登录页
    return { path: role === "user" ? "/UserLogin" : "/" };
  }
});
